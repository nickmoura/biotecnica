...
const Products = () => {
	const [products] = useState([
		...
		{
			id: 68, name: 'Palmilha com "U" Assimétrico', category: 'Palmilhas Ortopédicas', subcategory: 'Adulto', image: '/img/products/palmilha-com-U-2.jpg', description: 'Suporte ou apoio no arco longitudinal medial com elevação nas bordas do calcâneo em forma de “U” assimétrico. Indicado para esporão de calcâneo.'
		},
		{
		...
		{
			id: 71, name: 'Palmilha com Arco de Cunha Medial no Retropé', category: 'Palmilhas Ortopédicas', subcategory: 'Adulto', image: '/img/products/palmilha-com-arco-2.jpg', description: 'Suporte ou apoio no arco longitudinal medial com elevação medial no retropé. Indicado para pés planos valgos.'
		},
		{
		...
		{
			id: 73, name: 'Palmilha com Cunha Lateral no Retropé', category: 'Palmilhas Ortopédicas', subcategory: 'Adulto', image: '/img/products/palmilha-c-cunha-lateral-3.jpg', description: 'Suporte ou apoio no arco longitudinal medial com elevação lateral no retropé. Indicações para pés cavos, varos ou com rotação.'
		},
		{
		...
		{
			id: 76, name: 'Palmilha com reforço no arco longitudinal', category: 'Palmilhas Ortopédicas', subcategory: 'Adulto', image: '/img/products/palmilha-com-reforco-2.jpg', description: 'Elevação do arco longitudinal medial. Indicada para pés planos, valgas com desabamento do arco medial.'
		},
		{
		...
		{
			id: 78, name: 'Palmilha Helicoidal', category: 'Palmilhas Ortopédicas', subcategory: 'Adulto', image: '/img/products/palmilha-helico-2.jpg', description: 'Suporte ou apoio no arco longitudinal medial com elevação lateral no retropé. Indicações para pés planos e pronados.'
		},
		{
			id: 79, name: 'Palmilha Valente - correção 1 (infantil)', category: 'Palmilhas Ortopédicas', subcategory: 'Infantil', image: '/img/products/palmilha-inf-1-2.jpg', description: 'A Palmilha Valente – Correção 1 é indicada para apoio em ¼ esfera (coxim navicular) plana.'
		},
		{
			id: 80, name: 'Palmilha Valente - correção 1 (adulta)', category: 'Palmilhas Ortopédicas', subcategory: 'Adulto', image: '/img/products/palmilha-adulto-1-2.jpg', description: 'Suave apoio da abóbada plantar, compensação do 2º, 3º e 4º metatarso.'
		},
		{
			id: 81, name: 'Palmilha Valente – Correção 2 (infantil)', category: 'Palmilhas Ortopédicas', subcategory: 'Infantil', image: '/img/products/Produto-sem-foto.jpg', description: 'A Palmilha Valente – Correção 2 é indicada para cunha varizante do retropé com ¼ de esfera no navicular.'
		},
		{
			id: 82, name: 'Palmilha Valente – Correção 2 (adulto)', category: 'Palmilhas Ortopédicas', subcategory: 'Adulto', image: '/img/products/palmilha-com-reforco-2.jpg', description: 'Suave apoio da abóbada plantar, compensação do 1º e 5º metatarso.'
		},
		{
			id: 83, name: 'Palmilha Valente – Correção 3 (infantil)', category: 'Palmilhas Ortopédicas', subcategory: 'Infantil', image: '/img/products/palmilha-com-reforco-2.jpg', description: 'A Palmilha Valente – Correção 3 é indicada para a cunha pronadora do antepé com ¼ de esfera no navicular.'
		},
		{
		...
		{
			id: 85, name: 'Palmilha Valente – Correção 4 (infantil)', category: 'Palmilhas Ortopédicas', subcategory: 'Infantil', image: '/img/products/palmilha-inf-4-2.jpg', description: 'A Palmilha Valente – Correção 4 é indicada para cunha varizante no retropé e pronadora do antepé com ¼ de esfera no navicular.'
		},
		{
